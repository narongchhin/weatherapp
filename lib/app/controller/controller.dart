...
class WeatherController extends GetxController {
  ...
  final _mainWeather2 = MainWeatherCache().obs;
  ...
  MainWeatherCache get mainWeather2 => _mainWeather2.value;
  ...
  Future<void> getCurrentLocation() async {
    ...
    // _mainWeather2.value = await WeatherAPI()
    //     .getWeatherDataWithFilter(_latitude.value, _longitude.value);
  ...
  LocationCache getLocationCached() {
    LocationCache? locationCache;

    while (locationCache == null) {
      locationCache = isar.locationCaches.where().findFirstSync();
    }
