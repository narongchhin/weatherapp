...
class MainWeatherCache {
  ...
  Map<String, dynamic> toJson() => {
        ...
        'et0_fao_evapotranspiration': uvIndexMax,
        'rainSum': rainSum,
        'winddirection10MDominant': winddirection10MDominant,
        'timezone': timezone,
        'timestamp': timestamp,
        'et0_fao_evapotranspiration2': eta,
      };
}
...
class WeatherCard {
  ...
  Map<String, dynamic> toJson() => {
        ...
        'district': district,
        'index': index,
        'et0_fao_evapotranspiration1': eta,
      };
  ...
  factory WeatherCard.fromJson(Map<String, dynamic> json) {
    return WeatherCard(
      ...
      uvIndex: List<double?>.from(json['et0_fao_evapotranspiration'] ?? []),
      ...
      eta: List<double?>.from(json['et0_fao_evapotranspiration'] ?? []),
